...
const Navbar = () => {
    ...
    return (
      <div className='flex item-centre justify-between py-5 font-medium'>
        ...
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${vissible? 'w-full':'w-0'}`}>
          <div className="flex flex-col text-gray-600">
            <div onClick={()=>setVissible(false)} className="flex items-center gap-4 p-3 cursor-pointer">
